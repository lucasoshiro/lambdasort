...
#list operations
LAMBDA_CONCAT = (lambda r: r(r)) (lambda r: lambda l1: (lambda c: lambda t: lambda e: c(t)(e))(LAMBDA_ISEMPTY(LAMBDA_CDR(l1)))(lambda l2: LAMBDA_CONS(LAMBDA_CAR(l1))(l2))((lambda r: lambda l2: LAMBDA_CONS(LAMBDA_CAR(l1))(r(r)(LAMBDA_CDR(l1))(l2)))(r)))


_quicksort = lambda r: lambda A: lambda LR: (lambda c: lambda t: lambda e: c(t)(e))(LAMBDA_ISEMPTY(r(r)(LAMBDA_CAR(LR))))(LAMBDA_CONS(LAMBDA_CAR(LAMBDA_CDR(LR)))(r(r)(LAMBDA_CDR(LAMBDA_CDR(LR)))))(LAMBDA_CONCAT(r(r)(LAMBDA_CAR(LR)))(LAMBDA_CONS(LAMBDA_CAR(LAMBDA_CDR(LR)))(r(r)(LAMBDA_CDR(LAMBDA_CDR(LR))))))
